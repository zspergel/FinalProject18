...
def main_loop():
    ...
    intro7=font.render('you can only place pieces in your bottom 4 row. Their are 2 lakes in the middle',True,blue)
    intro8=font.render('use the WASD keys to move.',True,blue)
    ...
    screen.blit(intro8,(25,325))
    screen.blit(intro5,(25,375))
    pygame.display.update()
    enter()
    while running:
        for event in pygame.event.get():
